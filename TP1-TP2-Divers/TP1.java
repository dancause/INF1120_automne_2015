...
public class TP1 {
    ...
    public static void main (String[] params) {
        ...
        /*************Valeurs Static*************************************************/
        //Serins prix
        final double  prixSerins = 21.99;
        //Perruches prix
        final double  prixAlbino = 32.49;
        final double  prixOndulee = 27.99;
        final double  prixLutino =  35.99;
        //Tortues Prix
        final double  prixTortuePetite = 12.99;
        final double  prixTortueMoyenne =  23.99;
        final double  prixTortueGrosse =  39.49;
    
        /*************valeur temporaire pour la production facture*********************/
        double tempMontantFacture=0;
        ...
        reponse = Character.toUpperCase(Clavier.lireCharLn());
            ...
            System.out.println("Afficher message d’erreur entré invalide");
            System.out.println("Voulez-vous continuer 'c' ou mettre fin au programme 'f' ");
            System.out.print("choix: ");
            reponse = Character.toUpperCase(Clavier.lireCharLn());
        }
        ...
        if(montantTotalFactures !=0){
            ...
            System.out.println("Montant total des factures: "+montantTotalFactures);
